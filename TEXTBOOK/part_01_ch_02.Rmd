...
<<<<<<< HEAD
```{r knitr-logo, out.width='32.8%', fig.cap='Three knitr logos included in the document from an external PNG image file.'}
knitr::include_graphics('figures/Positive_Relationship_Plot_Corr.png')
```

=======
>>>>>>> 5d68bb14f564c362a7e0a687aaf0f0e6a427b81f
